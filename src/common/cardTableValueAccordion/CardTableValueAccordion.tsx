...
const accordionClasses: Partial<AccordionClasses> = {
...
const accordionDetailsClasses: Partial<AccordionDetailsClasses> = {
...
const CardTableValueAccordion: React.FC<
  PropsWithChildren<CardTableValueAccordionProps>
> = ({ keyLabel, valueLabel, children }) => {
  ...
  return (
    <div className={cn(styles.accordionWrapper, isExpanded && styles.active)}>
      ...
      >
        <AccordionSummary
          expandIcon={
            <ChevronDownIcon className={styles.accordionSummaryExpandIcon} />
          }
