...
export type AddActionOnSuccessType<InputType> = InputType &
  AdditionalActionOnSuccessType;

export type AddActionOnErrorType<InputType> = InputType &
  AdditionalActionOnErrorType;

export type AddActionOnSuccessAndErrorType<InputType> = InputType &
  AdditionalActionOnSuccessType &
  AdditionalActionOnErrorType;
